defmodule NervesSystemRpi0GMassStorage.MixProject do
  use Mix.Project

  @app :nerves_system_rpi0_gmassstorage
  ...
  defp nerves_package do
    [
      type: :system,
      artifact_sites: [
        {:github_releases, "fairbanksg/#{@app}"}
      ],
  ...
  defp package do
    [
      files: package_files(),
      licenses: ["Apache 2.0"],
      links: %{"GitHub" => "https://github.com/fairbanksg/#{@app}"}
    ]
  end
